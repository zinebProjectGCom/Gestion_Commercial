...
<form class="row g-3" action="{{route('produits.store')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="mb-3">
        @error('codebarre')
        ...
        <input type="text" name="codebarre" class="form-control" id="codebarre" value="{{old('codebarre')}}">
    </div>
    <div class="mb-3">
        @error('designation')
        <p class="alert alert-danger">{{ $message }}</p>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="prix_ht" class="form-control" id="prix_ht" value="{{old('prix_ht')}}">
    </div>
    <div class="mb-3">
        @error('stock')
        <p class="alert alert-danger">{{ $message }}</p>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="tva" class="form-control" id="tva" value="{{old('tva')}}">
    </div>
    <div class="mb-3">
        @error('image')
        <p class="alert alert-danger">{{ $message }}</p>
